...
import "./navbar.css";
import startNode from '../pictures/startNode.png';
import finishNode from '../pictures/finishNode.png';
import wall from '../pictures/wall.png';
import shortestPath from '../pictures/shortestPath.png';
import unvisited from '../pictures/unvisited.png';
import visitedNode from '../pictures/visitedNode.png';
...
class NavBar extends Component {
  ...
  visualizeAlgorithm() {
    ...
    if (
      ...
      if (this.state.algorithm === "Start Dijkstra")
        this.props.visualizeDijkstra();
      else if (this.state.algorithm === "Start A*")
        this.props.visualizeAStar();
      else if (this.state.algorithm === "Start Greedy BFS")
        this.props.visualizeGreedyBFS();
      else if (this.state.algorithm === "Start Bidirectional Greedy")
        this.props.visualizeBidirectionalGreedySearch();
      else if (this.state.algorithm === "Start Breadth First Search")
        this.props.visualizeBFS();
      else if (this.state.algorithm === "Start Depth First Search")
        this.props.visualizeDFS();
      else if (this.state.algorithm === "Start Random Walk")
          ...
          <ul className="navbar-nav">
              ...
              <div className="dropdown">
                ...
                <div className="dropdown-menu" aria-labelledby="dropdownMenu1">
                  <button
                    ...
                    type="button"
                    onClick={() => this.selectAlgorithm("Start Dijkstra")}
                  >
                  ...
                  <button
                    className="dropdown-item btn-light"
                    type="button"
                    onClick={() => this.selectAlgorithm("Start A*")}
                  >
                    A* Algorithm
                  </button>
                  <button
                    className="dropdown-item btn-light"
                    type="button"
                    onClick={() => this.selectAlgorithm("Start Greedy BFS")}
                  >
                  ...
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      this.selectAlgorithm("Start Bidirectional Greedy")
                    }
                  >
                  ...
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      this.selectAlgorithm("Start Breadth First Search")
                    }
                  >
                  ...
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      this.selectAlgorithm("Start Depth First Search")
                    }
                  >
                    Depth First Search
                  </button>
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      this.selectAlgorithm("Start Random Walk")
                    }
                  >
                    Random Walk
                  </button>
            ...
            <li className="nav-item dropdown">
              <div className="dropdown">
                ...
                <div className="dropdown-menu" aria-labelledby="dropdownMenu1">
                  <li className="legend">
                  <img src={startNode} alt="startNode" className="image" /> - Start Node
                  </li>
                  <li className="legend">
                  <img src={finishNode} alt="startNode" className="image" /> - Finish Node
                  </li>
                  <li className="legend">
                  <img src={unvisited} alt="startNode" className="image" /> - Unvisited Node
                  </li>
                  <li className="legend">
                  <img src={visitedNode} alt="startNode" className="image" /> - Visited Node
                  </li>
                  <li className="legend">
                  <img src={wall} alt="startNode" className="image" /> - Wall Node
                  </li>
                  <li className="legend">
                  <img src={shortestPath} alt="startNode" className="image" /> - Shortest Path
                  </li>
                </div>
              </div>{" "}
            </li>
